...
export default function PokedexExplorer() {
  ...
  return <main className="collection-page">
    ...
    <header className="collection-header"><Link href="/" className="collection-back"><ArrowLeft size={20} aria-hidden="true" /> Início</Link><div className="collection-header-links"><Link href="/como-jogar">Como jogar</Link><CoinBalance /><Link href="/batalha">Batalhar</Link></div></header>
