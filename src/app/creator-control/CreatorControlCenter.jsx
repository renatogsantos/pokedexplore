      ...
      <div className="creator-shell">
        ...
        <div className="creator-layout">
          ...
          <section className="creator-workspace" id="creator-content" tabIndex={-1}>
            <div className="creator-mobile-navigation">
              ...
              <label className="creator-mobile-section-select">Seção atual<select value={activeTab} onChange={(event) => setActiveTab(event.target.value)}>{TABS.map(([id, label]) => <option key={id} value={id}>{label}</option>)}</select></label>
            </div>
