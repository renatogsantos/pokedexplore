...
export const ITEM_CATALOG = Object.freeze([
  ...
  item({
    ...
    rarity: "RARE",
    role: "healing",
    shortDescription: "Cura crítica • 35%",
    description:
      "Quando fica com 25% de HP ou menos após receber dano, recupera 35% da vida máxima.",
    effectType: "HEAL_PERCENT",
    trigger: "AFTER_DAMAGE",
    consumable: true,
    price: 120,
    rules: { hpRatioLTE: 0.25, healPercent: 0.35 },
  }),
  item({
    ...
    rarity: "RARE",
    role: "healing",
    shortDescription: "Regenera 5% por 3 turnos",
    description:
      "Ao cair para 50% de HP ou menos após receber dano, regenera 5% da vida máxima por 3 turnos.",
    effectType: "REGENERATION",
    trigger: "AFTER_DAMAGE",
    consumable: true,
    price: 135,
    rules: { hpRatioLTE: 0.5, healPercent: 0.05, ticks: 3 },
  }),
  item({
    id: "survival-amulet",
  ...
  item({
    ...
    rarity: "RARE",
    role: "defense",
    shortDescription: "Super efetivo −15%",
    description: "Ataques super efetivos causam 15% menos dano.",
    effectType: "INCOMING_DAMAGE",
    trigger: "DAMAGE_CALCULATION",
    consumable: false,
    price: 150,
    rules: { multiplier: 0.85, superEffectiveOnly: true },
  }),
  item({
    id: "arcane-mirror",
    name: "Espelho Arcano",
  ...
  item({
    ...
    rarity: "RARE",
    role: "status",
    shortDescription: "Remove o primeiro estado",
    description:
      "Remove automaticamente o primeiro estado negativo aplicado ao portador.",
  ...
  item({
    ...
    rarity: "RARE",
    role: "attack",
    shortDescription: "+10% dano • recebe +5%",
    description: "Causa 10% mais dano, mas também recebe 5% mais dano.",
    effectType: "DAMAGE_TRADEOFF",
    trigger: "DAMAGE_CALCULATION",
    consumable: false,
    price: 150,
    rules: { dealtMultiplier: 1.1, receivedMultiplier: 1.05 },
  }),
  item({
    id: "elemental-core",
    ...
    rarity: "RARE",
    role: "attack",
    shortDescription: "Golpe primário +12%",
    description: "Golpes do tipo primário do portador causam 12% mais dano.",
    effectType: "TYPE_DAMAGE",
    trigger: "DAMAGE_CALCULATION",
    consumable: false,
    price: 165,
    rules: { multiplier: 1.12 },
  }),
  item({
    id: "impact-crystal",
  ...
  item({
    ...
    rarity: "RARE",
    role: "tactical",
    shortDescription: "Após troca, próximo ataque +15%",
    description:
      "Depois de entrar por uma troca, o próximo ataque bem-sucedido causa 15% mais dano.",
  ...
  item({
    ...
    rarity: "RARE",
    role: "tactical",
    shortDescription: "Revela a efetividade",
    description:
      "Mostra informações de efetividade dos golpes do portador contra o oponente atual.",
  ...
  item({
    ...
    rarity: "RARE",
    role: "defense",
    shortDescription: "Próximo dano −30%",
    description:
      "O próximo ataque recebido pelo Pokémon ativo causa 30% menos dano.",
    effectType: "BAG_BARRIER",
    trigger: "MANUAL",
    consumable: true,
    price: 120,
    rules: { multiplier: 0.7 },
  }),
  item({
    id: "stimulant",
    name: "Estimulante",
    ...
    rarity: "RARE",
    role: "attack",
    shortDescription: "Próximo ataque +20%",
    description:
      "O próximo ataque bem-sucedido do Pokémon ativo causa 20% mais dano.",
  ...
  item({
    ...
    rarity: "LEGENDARY",
    role: "survival",
    shortDescription: "Sobrevive • 60% da vida • próximo ataque +15%",
    description:
      "Impede uma derrota por dano, recupera 60% da vida máxima e fortalece o próximo ataque em 15%.",
    effectType: "SURVIVE_AND_BUFF",
    trigger: "BEFORE_LETHAL_DAMAGE",
    consumable: true,
    price: 1200,
    rules: { healPercent: 0.6, multiplier: 1.15 },
  }),
  item({
    id: "challenger-crown",
    ...
    rarity: "LEGENDARY",
    role: "tactical",
    shortDescription: "Contra nível maior: +10%/−10%",
    description:
      "Contra um oponente de nível maior, causa 10% mais dano e recebe 10% menos dano.",
    effectType: "UNDERDOG",
    trigger: "DAMAGE_CALCULATION",
    consumable: false,
    price: 750,
    rules: { dealtMultiplier: 1.1, receivedMultiplier: 0.9 },
  }),
  item({
    id: "void-fragment",
    ...
    rarity: "LEGENDARY",
    role: "defense",
    shortDescription: "Primeiro super efetivo −40%",
    description: "Reduz em 40% o primeiro ataque super efetivo recebido.",
    effectType: "INCOMING_DAMAGE",
    trigger: "DAMAGE_CALCULATION",
    consumable: true,
    price: 825,
    rules: { multiplier: 0.6, superEffectiveOnly: true },
  }),
  item({
    id: "celestial-clock",
    ...
    rarity: "LEGENDARY",
    role: "status",
    shortDescription: "Impede estado • cura 10%",
    description:
      "Impede o primeiro estado negativo e recupera 10% da vida máxima.",
